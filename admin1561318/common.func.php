...
//PHP_Mailer設定檔
		$PHP_Mailer_host="mail.webg.tw"; // Specify main and backup SMTP servers
		$PHP_Mailer_SMTPAuth="true"; // Enable SMTP authentication
		$PHP_Mailer_Username="test@webg.tw"; // SMTP username
		$PHP_Mailer_Password="Zh617bw&"; // SMTP password
		...
		$PHP_Mailer_setFrom_mail="test@webg.tw";
