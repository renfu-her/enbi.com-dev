    ...
    <div id="side-nav">
      <ul id="nav">
        <li <?if($_GET['ct']=='1'){ echo 'class="current"';}?>> <a href="index.php?ct=1"> 首頁輪播banner </a> </li>
         ...
         <li <?if($_GET['ct']=='ind_banner'){ echo 'class="current"';}?>> <a href="index.php?ct=ind_banner"> 首頁下方輪播banner </a> </li>
		...
		<li <?if($_GET['ct']=='ind_unboxing'){ echo 'class="current"';}?>> <a href="index.php?ct=ind_unboxing"> 開箱特輯 </a> </li>
        <li <?if($_GET['ct']=='9'){ echo 'class="current"';}?>> <a href="index.php?ct=9"> 經銷據點 </a> </li>
        
        <li <?if($_GET['ct']=='ind_mail'){ echo 'class="current"';}?>> <a href="index.php?ct=ind_mail"> 合作洽談 </a> </li>
