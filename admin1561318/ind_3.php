...
$ary_data = $obj_news -> fetchAll_join(' * ', " ORDER BY `newsdate` DESC ",True , array($pageNow-1 , $pageNum));   //取出所需會員資料




$page = new SplitPage($pageNow, $obj_news->num, $pageNum, 10);  //建構出 SplitPage 物件
								...
								<table class="table table-striped">
									...
									<tbody class="tbodyC">
										...
										<tr>
											...
											<td style="vertical-align:middle;">
												<img src="../uploads/<?php echo $value['pic']?>" height="80px">
											</td>
											<td style="vertical-align:middle;">
