...
$banner_time  =	date("Y-m-d H:i:s");//新增時間
$postwho = $_SERVER['REMOTE_ADDR'];
...
:banner_time
	...
	$result->bindValue(':banner_time', $banner_time, PDO::PARAM_STR);
...
<script language="javascript">
	top.location.href='./index.php?ct=ind_banner&msg=add';
</script>
